 ...
 *      entering it switches to presenting mode (rail hidden), leaving
 *      it (Esc / P again) restores the editor chrome.
...
(() => {
  ...
  class DeckStage extends HTMLElement {
     ...
     *  across the flip, a stale pin would hold the first summoned overlay
     *  open with no pointer anywhere near it. Hide on BOTH transitions:
     *  entry cleans the audience's screen, and on exit a pin-skipped hide
     *  timeout may have left data-visible set with no timer armed. */
    _setPresenting(on) {
      on = !!on;
